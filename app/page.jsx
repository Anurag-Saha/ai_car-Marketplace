...
export default async function Home() {
  ...
  return (
    <div className="pt-20 flex flex-col">
      {/* hero */}
      <section className="realative py-16 md:py-28 dotted-background">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-500 mb-8 max-w-2xl mx-auto">
              Advance Ai Car Search and test drive your dream car
            </p>
          </div>
          {/* search */}
          <HomeSearch />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-x1 font-bold mb-2">Wide Selection</h3>
              <p className="text-gray-600">
                Thousand of verified vechicles from trusted dealerships and
                private sellers.
              </p>
            </div>
            <div className="text-center">
